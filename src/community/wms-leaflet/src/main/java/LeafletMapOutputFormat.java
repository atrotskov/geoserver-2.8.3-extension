...
public class LeafletMapOutputFormat implements GetMapOutputFormat {
    ...
    private static final Logger LOGGER = Logging.getLogger(LeafletMapOutputFormat.class);
    ...
    /**
     * Set of parameters that we can ignore, since they are not part of the Leaflet WMS request
     */
    ...
    static {
        ...
        cfg.setClassForTemplateLoading(LeafletMapOutputFormat.class, "");
